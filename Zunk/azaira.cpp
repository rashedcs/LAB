...
void drawFullHand()
{
  ...
  /*** 3rd portion of hand ***/
    glPushMatrix();
        glRotatef(backMove_angle, 1, 0, 0);
        glRotatef(fullHand_angle, 0, 1, 0);
        glTranslatef(0.0,0, - (2*(5*radius)));    //length of upper part    ///glTranslatef(0,0,-160);   //translate=-length of upper and lower part+height of triangle
        glRotatef(lowerPart_angle,0,1,0);
