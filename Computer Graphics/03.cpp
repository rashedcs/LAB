...
ll  cameraHeight, cameraAngle,  angle;
ll  fullHand_angle=0.0;
ll  backMove_angle=0.0;
ll rigthFinger_angle=0.0;
ll  leftFinger_angle=0.0;
ll  middleFinger_angle=0.0;
ll lowerPart_angle=0.0;
ll palm_angle;
